 ...
 * TODO: try to do it by setting URL params like this: location.assign(href + '?Grid-page=1&Grid-orderBy=~&Grid-filter=~&Grid-size=50');
 */
function show50ItemsPerPage() {
    setTimeout(function() {
...
$(document).ready(function() {
    ...
    if (/CampaignBuilder.*DomainActions$/.test(href)) {
        show50ItemsPerPage();
    }
    ...
    if (/Admin.*ActionLog/.test(path)) {
        $('#bRefresh, #bApply').click(show50ItemsPerPage);
